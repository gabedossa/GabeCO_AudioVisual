...
export default function Portfolio() {
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <CardFilmes title="O Pantaneiro" trailerUrl="https://www.youtube.com/" imgFilme="/img/Capa_Pantaneiro.jpg" ano= {2006} duracao="60 min" genero={["Documentario"]} diretor="Aroldo Maciel" description="Um documentário sul Africano."/>   
    </div>
  ...
  <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <CardFilmes title="Matogrosso Canta e encanta. " imgFilme="/img/Matogrosso_encanta.jpg" ano= {2009} duracao="60 min" genero={["Disco"]} artista="Vários artistas" description="Uma narrativa sobre um dos pavos indígenas do Matogrosso."/>   
      <CardFilmes title="Matogrosso Canta e encanta. " imgFilme="/img/Matogrosso_encanta.jpg" ano= {2010} duracao="60 min" genero={["Disco"]} artista="Ana Cecilia dos Santos" description="Uma narrativa sobre um dos pavos indígenas do Matogrosso."/>   
    </div>
  </div>
</section>
<Footer />
